...
// //     headerUsername.innerHTML = updateUser.username;
// //     let rolesStr = "";
// //     for (let i = 0; i < updateUser.roles.length; i++) {
// //         rolesStr += updateUser.roles[i];
// //         if (i >= updateUser.roles.length - 1) break;
// //         rolesStr += ", ";
// //     }
// //     headerRoles.innerHTML = rolesStr;
// //
// //     let userTableBody = document.getElementById('user_table_body');
// //     userTableBody.appendChild(userRowSimple(updateUser));
// // }
//
...
//     let openDeleteModalUserOption = document.getElementById('user_option_del');
//     contains(deletableUser.roles, 'USER') ? openDeleteModalUserOption.setAttribute('selected', '') : openDeleteModalUserOption.removeAttribute('selected');
//     let openDeleteModalAdminOption = document.getElementById('admin_option_del');
//     contains(deletableUser.roles, 'ADMIN') ? openDeleteModalAdminOption.setAttribute('selected', '') : openDeleteModalAdminOption.removeAttribute('selected');
